...
df_frequencias = pd.DataFrame({
    ...
    'Frequência Relativa (fr)': frequencia_relativa.map('{:.2%}'.format), # Formatando como porcentagem
...
plt.ylabel('') # Remove o rótulo 'Nota' do eixo y
plt.show()

# Histograma (para dados contínuos ou com muitas categorias)
